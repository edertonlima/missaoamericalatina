<?php
	...
	$email_remetente = 'contato@briquetesecomais.com.br';
	...
	$conteudo .= '<br><strong>Telefon:</strong> '.$telefone;
	$conteudo .= '<br><strong>E-mail:</strong> '.$email;
	$conteudo .= '<br><strong>Endereço:</strong> '.$cidade.', '.$estado;
	$conteudo .= '<br><br><strong>'.$assunto.'</strong>';
